...
@rem ##########################################################################
@rem
@rem  CampAdminConsole startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CAMP_ADMIN_CONSOLE_OPTS to pass JVM options to this script.
...
:fail
rem Set variable CAMP_ADMIN_CONSOLE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CAMP_ADMIN_CONSOLE_EXIT_CONSOLE%" exit 1
exit /b 1
